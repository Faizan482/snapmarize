...
export default async function SummaryPage(props: { params: Promise<{ id: string }> }) {
  ...
  const reading_time = Math.ceil(word_count / 200); // Assuming average reading speed of 200 wpm
  return (
    <div className="relative isolate min-h-screen bg-linear-to-b from-rose-50/40 to white">
      ...
      <div className="container mx-auto flex flex-col gap-4">
        <div className="px-4 sm:px-6 lg:px-8  py-6 sm:py-12 lg:py-24">
          ...
          {file_name && <SourceInfo title={title} summaryText={summary_text} fileName={file_name}  createdAt={created_at} originalFileUrl={original_file_url} />}
