...
export default function ProgressBar({ section, currentSection }: { section:Array<{ title: string; content: string[] }>; currentSection: number }) {
  return (
      ...
      <div className="px-4 flex gap-1.5">
        {section.map((sec, index) => (
          ...
          <div key={index}  className={cn(
            "h-1.5 bg-linear-to-r from-gray-500 to-rose-600 transition-all duration-500",
