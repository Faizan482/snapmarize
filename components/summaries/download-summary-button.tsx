...
link.href = url;
link.download = `Summary-${title.replace(/[^a-zA-Z0-9-_ ]/g, "_")}.txt`;
...
URL.revokeObjectURL(url);
  ...
  return (
    <Button size="sm" className="h-8 px-3 text-rose-600 bg-rose-100 hover:text-rose-700 hover:bg-rose-50" onClick={handleDownload}>
