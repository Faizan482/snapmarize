...
const SummaryHeader = ({ fileUrl, title, createdAt }: { fileUrl: string, title: string | null, createdAt: string }) => {
  return <div className="flex items-start gap-2 sm:gap-4 mt-1">
    <FileText className="h-6 w-6 sm:w-8 sm:h-8 text-rose-400 " />
...
export default function SummaryCard({ summary }: { summary: any }) {
  return (
    <div>
      <Card className="relative h-full bg-white border border-gray-50 shadow-sm ">
